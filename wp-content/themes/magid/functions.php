...
<script type="text/javascript">
 jQuery(document).ready(function($){
  ...
  jQuery("#memberdropmb").change(function(){
    ...
    var items_value = jQuery('option:selected', this).attr('data-value');
    var items_name = jQuery('option:selected', this).attr('data-title');
    var items_description = jQuery('option:selected', this).attr('data-description');
    var url = jQuery(this).val();
    membersQuery._init(items_value);
    jQuery('#memberTermName').html(items_name);
    jQuery('#memberTermDesc').html(items_description);
...
SCRIPT;
    ...
    $return = '';
	  ...
	  $return .="<div class='me_sel'><select  class='drop-menu ".$sele."' name='memberdropmb'  id='memberdropmb' >";
    ...
    foreach($tax_terms as $term){
            ...
            $sele = $default_skill == $term->term_id ? 'selected':'';
               $return .= "<option class='optn' value='".$term_links."' ".$sele." data-value='".$term->term_id."' data-description='".$term->description."' data-title='".$term->name."'>".$term->name."</div></option>";
           }
    $return .="</select></div>";
