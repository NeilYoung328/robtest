 ...
 * @see Walker
 */
class SkillDropdownWalker extends Walker_CategoryDropdown {
    ...
    public function start_el( &$output, $category, $depth = 0, $args = [], $id = 0 ) {
        ...
        $output .= "\t<option description=\"$category->description\" permalink=\"$category_link\" class=\"level-$depth\" value=\"" . esc_attr( $category->{$value_field} ) . "\"";
