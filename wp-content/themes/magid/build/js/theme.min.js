function abc(yourStrin , maxLength){
   
        var yourString = yourStrin+' ';
...
var blogfilters = function(e) {
    ...
    blogPosts = function(e) {
        ...
        return t._init = function() {
        ...
        }, t._articleItemMarkup = function(e, t, i, n) {
            ...
            var ct = $(e.content.rendered).text(); 
			//alert(ct);
            if("left" === i){
            ...
            }else
			{
                ...
                s = "";
            return "undefined" != typeof e.mention.external && (e.link = e.mention.external.url, e.mention.excerpt = e.mention.external.excerpt, s = 'target="_blank"'), '<div class="mention mention--' + i + '" style="background: ' + t + '">' + ("top" === i ? '<div class="entry__thumb"><a rel="bookmark" href="' + e.link + '"><img src="' + uy + '" itemprop="image" style="opacity: 1;"></a></div>' : "") + ("left" === i ? '<a rel="bookmark" href="' + e.link + '" class="entry__background" style="background-image: url(' + uv + '); opacity: 1;"></a>' : "") + '<article id="post-' + e.id + '" class="entry entry__post--' + i + " post-" + e.id + '"><div class="entry__meta"><div class="meta__date" style="color:' + n + ';"><span class="meta__author">By ' + e.mention.author + "</span>" + e.mention.date + '</div><span class="entry-terms category" itemprop="articleSection">' + e.mention.terms + '</span></div><header class="entry__header"><h2 class="hdg hdg--3 hdg--medium"><a rel="bookmark" href="' + e.link + '" ' + s + ">" + a + "</a> </h2></header>" + ('<div class="entry__excerpt">' + ex + "</div>") + '<a class="entry_read-more" href="' + e.link + '" style="color:' + n + ';" ' + s + '><svg class="icon icon-arrow" style="fill: ' + n + ';"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-arrow"></use></svg>Read More</a></article></div>'
        }, t
    }(jQuery),
    ...
    membersQuery = function(e) {
        ...
        var t = {},
            i = e("#membersList");
        return t._init = function(custeam) {
            ...
            i.length > 0 && (i.selectize({
                    ...
                    i.each(function(i, n) {
                        if ("undefined" != typeof n.attributes.description) {
                            var a = {
                                ...
                                permalink: n.attributes.permalink.value
                            };
                ...
                render: {
                    option: function(e, t) {
					//console.log(e);
                        return '<div class="option" data-description="' + e.description + '" data-href="' + e.permalink + '">' + e.text + "</div>"
                    }
                },
...
jQuery(document).ready(function(){
    ...
    jQuery('a.cus_exp').click(function(e){
        e.preventDefault();
        var items_value = jQuery(this).attr('data-value');
        var items_name = jQuery(this).attr('data-title');
        var items_description = jQuery(this).attr('data-description');
        var url = jQuery(this).attr('href');
        membersQuery._init(items_value);
        jQuery('#memberTermName').html(items_name);
        jQuery('#memberTermDesc').html(items_description);
        jQuery('.sel_ex').removeClass('selected');
...
jQuery(document).on('change','div.option',function(){
       alert('hello');
        var uri = jQuery(this).attr('data-href');
